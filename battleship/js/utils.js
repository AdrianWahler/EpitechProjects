...
(function (global) {
    ...
    global.utils = {
        CELL_SIZE: 60,
        // créer un tableau à deux dimension, chaque élément du
        // tableau est définie à la valeur (optionelle)
        // "value" (vaut 0 par défaut)
        ...
        // retourne la position (démarre à 1) du
        // noeud passé en paramètre dans son parent
        eq: function (node) {
        ...
        // les 2 derniers paramètres sont des callback a
        // exécuter en cas de confirmation pour le deuxième,
        // ou d'infirmation pour le dernier
